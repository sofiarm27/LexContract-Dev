...
const Clients = () => {
    ...
    const clientsData = [
        { id: 'LC-2401', cedula: '1.234.567.890', nombre: 'Carlos Eduardo Ruiz', celular: '+57 300 123 4567', correo: 'carlos.ruiz@email.com', direccion: 'Calle 45 #12-34', ciudad: 'Bogotá', estado: 'Activo' },
        { id: 'LC-2402', cedula: '52.987.654', nombre: 'María Helena Giraldo', celular: '+57 320 087 6543', correo: 'm.giraldo@gmail.com', direccion: 'Av. Siempre Viva 742', ciudad: 'Medellín', estado: 'Activo' },
        { id: 'LC-2403', cedula: '1.010.555.222', nombre: 'Roberto Carlos Montoya', celular: '+57 315 555 2222', correo: 'rcarlos@empresa.co', direccion: 'Carrera 10 #5-20', ciudad: 'Cali', estado: 'Pendiente' },
        { id: 'LC-2404', cedula: '32.111.333', nombre: 'Elena Torres Blanco', celular: '+57 300 111 3333', correo: 'elenat@email.com', direccion: 'Transversal 5 #88-11', ciudad: 'Bogotá', estado: 'Activo' },
        { id: 'LC-2405', cedula: '1.200.777.222', nombre: 'Juan Pablo Morales', celular: '+57 321 777 2222', correo: 'j.morales@legal.com', direccion: 'Calle 100 #15-40', ciudad: 'Barranquilla', estado: 'Inactivo' },
    ];
                        ...
                        <tbody>
                            {filteredClients.map((client) => (
                                <tr key={client.id} style={{ borderBottom: '1px solid var(--border-color)', fontSize: '0.875rem', transition: 'background-color 0.2s' }}>
                                    <td style={{ padding: '1rem 1.5rem', color: 'var(--accent-gold)', fontWeight: 600 }}>{client.id}</td>
