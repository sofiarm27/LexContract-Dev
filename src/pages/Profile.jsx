...
const Profile = () => {
    ...
    const userData = {
        nombre: 'Admin Lex',
        apellido: 'Contract',
        correo: 'admin@lexcontract.com',
        celular: '+57 300 000 0000',
        rol: 'Administrador Senior',
        fechaIngreso: '12 de Enero, 2024',
        ubicación: 'Bogotá, Colombia',
        biografia: 'Responsable de la supervisión global de contratos y gestión de usuarios dentro de la plataforma LexContract.'
    };
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 1fr) 2fr', gap: '2rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    <Card style={{ textAlign: 'center', padding: '2.5rem' }}>
                        ...
                        <span style={{ color: 'var(--accent-gold)', fontWeight: 600, fontSize: '0.875rem' }}>{userData.rol}</span>
                    </Card>
                    ...
                    <Card style={{ padding: '1.5rem' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
                                <Calendar size={16} />
                                <span>Miembro desde: {userData.fechaIngreso}</span>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
                                <Shield size={16} />
                                <span>Última conexión: Hoy, 08:30 AM</span>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
                                <MapPin size={16} />
                                <span>{userData.ubicación}</span>
                            </div>
                        </div>
                    </Card>
                </div>
                    ...
                    <Card style={{ padding: '2rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                            ...
                            <div style={{ gridColumn: 'span 2' }}>
                                ...
                                <p style={{ fontSize: '1rem', fontWeight: 400, color: 'var(--text-secondary)', lineHeight: '1.6' }}>{userData.biografia}</p>
                            </div>
                        </div>
                    </Card>
                    ...
                    <Card style={{ padding: '2rem' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <div>
                                ...
                                <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>Última actualización hace 3 meses</p>
                            </div>
                        ...
                        <div style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginTop: '1rem' }}>
                                ...
                                <Button
                                    onClick={handleSave}
                                    style={{
                                        backgroundColor: isValid ? 'var(--accent-gold)' : '#1e2d45',
                                        color: isValid ? '#000' : '#475569',
                                        border: 'none',
